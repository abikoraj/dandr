<div class="p-5">
    ...
    <table class="table table-bordered f-12 text-start">
        ...
        @endif
        <tr class="no-border">
            <th colspan="4" class="text-right">GrandTotal:</th>
        ...
        @if ($bill->return > 0)
            ...
            <tr class="no-border">
                <th colspan="4" class="text-right">Return:</th>
                <td>{{ (float) $bill->return }}</td>
            </tr>
        @endif
        <tr class="no-border">
            <th colspan="4" class="text-right">Counter:</th>
            <td>{{  $bill->counter_name }}</td>
        </tr>
        <tr class="no-border">
            <th colspan="4" class="text-right">Printed Copy:</th>
            <td>{{  $bill->copy }}</td>
        </tr>
