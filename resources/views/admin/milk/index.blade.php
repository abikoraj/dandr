                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="session" id="session" class="form-control show-tick ms next"
                                data-next="loaddata">
                                <option></option>
                    ...
                    <div class="col-md-4 add-section">
                        <input type="number" name="milk_amount" id="m_amt" step="0.001" min="0.001"
            ...
            axios({
                ...
                .then(function(response) {
                    ...
                    if (session == 0) {
                        ...
                        document.querySelector('#milk-' + id+'>.m_milk').dataset.value = response.data.m_amount;
                        $('#m_milk-' + id).text(response.data.m_amount);
                    } else {
                        document.querySelector('#milk-' + id).dataset.e_amount = response.data.e_amount;
                        document.querySelector('#milk-' + id+'>.e_milk').dataset.value = response.data.e_amount;
