                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="name" name="name" class="form-control next"
                                            data-next="address" placeholder="Collection Center Name" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="address" name="address" class="form-control next"
                                            data-next="fat-rate" placeholder="Collection Center Address" required>
                                    </div>
                                </div>
                                @if (env('use_milk', false))
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <input type="number" id="fat-rate" name="fat_rate" class="form-control next"
                                                data-next="snf-rate" step="0.001" placeholder="Enter fat rate" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="name">Snf Rate</label>
                                        <div class="form-group">
                                            <input type="number" id="snf-rate" name="snf_rate" class="form-control"
                                                step="0.001" placeholder="Enter snf rate" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 {{ env('hasextra', 0) == 1 ? '' : 'd-none' }}">
                                        ...
                                        <div class="form-group">
                                            <input type="number" id="bonus" name="bonus" class="form-control"
                                                step="0.001" placeholder="Enter Bonus" value="0" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 {{ env('usetc', 0) == 1 ? '' : 'd-none' }}">
                                        ...
                                        <div class="form-group">
                                            <input type="number" id="tc" name="tc" class="form-control"
                                                step="0.001" placeholder="Enter TC Commission" value="0" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 {{ env('usecc', 0) == 1 ? '' : 'd-none' }}">
                                        <label for="name"> <input type="checkbox" name="show_cc" value="1"> Cooling
                                            Cost (per litre)</label>
                                        <div class="form-group">
