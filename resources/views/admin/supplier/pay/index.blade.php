                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <select name="user_id" id="u_id" class="form-control show-tick ms "
                                data-placeholder="Select" required>
                                <option value="-1"></option>
                                @foreach (\App\Models\User::where('role', 3)->get() as $d)
                                    <option value="{{ $d->id }}" id="opt-{{ $d->id }}">{{ $d->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-md-3 mt-4">
                        <input type="button" value="Load" class="btn btn-primary btn-block" onclick="loaddata();"
                            id="save">
    ...
    <script>
        ...
        function pay() {
            if ($('#amount').val() == "") {
                ...
                axios.post('{{ route('admin.supplier.due.pay') }}', data)
