            ...
            <table class="table">
                ...
                @foreach ($centers as $center)
                    <tr>
                        ...
                        <td> <input type="number" name="wholesale_{{$center->id}}" id="wholesale_{{$center->id}}" class="form-control"> </td>
                        <td> <input type="number" name="price_{{$center->id}}" id="price_{{$center->id}}" class="form-control"> </td>
                    </tr>
                @endforeach
            </table>
            </div>
