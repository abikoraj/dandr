            ...
            @if(!env('multi_package'))
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.00001" value="{{$variant->ratio}}" class="form-control" name="ratio" id="ratio">
                    </div>
                </div>
            @endif
                ...
                @foreach ($centers as $center)
                    ...
                    @endphp
                        <tr>
                            ...
                            <td> <input type="number" name="price_{{$center->id}}" id="price_{{$center->id}}"  value="{{$variant_price?$variant_price->price:''}}" class="form-control"> </td>
                        </tr>
                    @endforeach
            </table>
            </div>
