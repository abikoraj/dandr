                ...
                <div class="row">
                    ...
                    @if ($w)
                        <div class="col-lg-{{$r}}">
                            ...
                            <div class="form-group">
                                <input type="number" id="wprice"  step="0.001"  name="wholesale" min="0" class="form-control next" data-next="sprice" placeholder="Enter wholesale price" required value="{{$item->wholesale}}">
                            </div>
                        </div>
                    @endif
                    <div class="col-lg-6">
