...
@endsection
@section('head-title')
    <a href="{{ route('admin.report.home') }}">Report</a> / Farmer - With Milk
@endsection
@section('toobar')
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-3 d-flex align-items-end">
            <div>
                <input type="checkbox" name="show_detail" id="show_detail"> <label for="show_detail">Show Detail</label>
            </div>
        </div>
...
@section('js')
    ...
    <script>
        ...
        function loadData() {
            ...
            if($('#show_detail')[0].checked){
                d.show_detail=1;
            }
            axios.post("{{ route('admin.report.farmer.with.milk') }}", d)
