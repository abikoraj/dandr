<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="index.html"><img src="{{ asset('backend/images/logo.svg') }}" width="25" alt="Aero"><span class="m-l-10">{{env('product')}}</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
            ...
            @if (env('use_employee',false))
                ...
                <li><a href="javascript:void(0);" class="waves-effect waves-block menu-toggle"><i class="zmdi zmdi-shopping-cart"></i><span>Employee Chalan</span></a>
                    <ul class="ml-menu">
                        ...
                        <li><a href="{{ route('admin.employee.chalan.due.index')}}" class="waves-effect waves-block">Chalan Due</a></li>
                    </ul>
                </li>
            ...
            <li><a href="{{ route('admin.reconciliation.index') }}" class="waves-effect waves-block"><i class="zmdi zmdi-shopping-cart"></i><span>Reconciliation</span></a></li>
