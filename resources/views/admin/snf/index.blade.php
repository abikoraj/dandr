                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input type="text" name="date" id="nepali-datepicker" class="calender form-control"
                                placeholder="Date">
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 mt-4">
                        <input type="button" class="btn btn-primary btn-block next" data-next="u_id" onclick="loadData();"
                            onkeydown="loadData();" id="loaddata" value="Load">
                        {{-- <span >Load</span> --}}
                        <span class="btn btn-danger d-none" onclick="resetData()" id="resetdata"> Reset</span>
                    </div>
                    <div class="col-md-3 add-section">
                        <input type="text" list="farmerdatalist" name="user_id" id="u_id" placeholder="number"
                            class="form-control checkfarmer next" data-next="fat" min="1">
                    </div>

                    <div class="col-md-3 add-section">
                        <input type="number" name="fat" id="fat" step="0.001" min="0.001" placeholder="Fats"
                    ...
                    <div class="col-md-3 add-section">
                        <input type="button" class="btn btn-primary btn-block" onclick="saveDate();" value="Save"
                            id="saveData">
                        {{-- <span >Save</span> --}}
                    </div>
