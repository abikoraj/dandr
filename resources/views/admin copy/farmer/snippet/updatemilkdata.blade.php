        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="update_morninf" id="update_morning" class="form-control" step="0.01" >
                </div>

                <div class="col-md-6">
                    <label for="snf">Evening Milk</label>
                    <input type="number" name="update_evening" id="update_evening" class="form-control" step="0.01" >
                </div>
